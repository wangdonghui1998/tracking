...
def parameters():
    ...
    params.net = NetWithBackbone(net_path='prdimp50.pth',
                                 use_gpu=params.use_gpu)

    params.lstm_net_path = "/home/b311/data/wdh/pytracking/pytracking/pretrained_networks/lstm_cnn_deltaxy.pth"
