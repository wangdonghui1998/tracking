...
dataset_dict = dict(
    glass=DatasetInfo(module=pt % "glass", class_name="GlassDataset", kwargs=dict()),
    similar_train=DatasetInfo(module=pt % "similar", class_name="SimilarDataset", kwargs=dict(split='train')),
    similar_test=DatasetInfo(module=pt % "similar", class_name="SimilarDataset", kwargs=dict(split='test')),
    similar_val=DatasetInfo(module=pt % "similar", class_name="SimilarDataset", kwargs=dict(split='val')),
