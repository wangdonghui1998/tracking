...
def main():
    ...
    parser.add_argument('--tracker_name', type=str,default='lsdimp', help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default='lsdimp',help='Name of parameter file.')
    parser.add_argument('--runid', type=int, default=None, help='The run id.')
    parser.add_argument('--dataset_name', type=str, default='samiler_test', help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot ,glass).')
    parser.add_argument('--sequence', type=str, default="GOT-10k_Train_002787", help='Sequence number or name.')
