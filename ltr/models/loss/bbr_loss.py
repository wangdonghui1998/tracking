...
class GIoULoss(nn.Module):
    ...
    def forward(self, pred, target, weights=None):
        ...
        #pred: [1,1,4,18,18]   target[1,1,4,18,18]
        pred = pred.permute(0, 1, 3, 4, 2).reshape(-1, 4) # nf x ns x x 4 x h x w  [324,4]
        target = target.permute(0, 1, 3, 4, 2).reshape(-1, 4) #nf x ns x 4 x h x w [324,4]
