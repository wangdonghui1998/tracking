...
def main():
    ...
    parser.add_argument('--train_module', type=str,default="lsdimp", help='Name of module in the "train_settings/" folder.')
    parser.add_argument('--train_name', type=str, default="lsdimp50",help='Name of the train settings file.')
